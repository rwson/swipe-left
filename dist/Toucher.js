...
(function (root, factory) {
    ...
    function toArray(list) {
        if (list && (typeof list === "undefined" ? "undefined" : _typeof(list)) === "object" && isFinite(list.length) && list.length >= 0 && list.length === Math.floor(list.length) && list.length < 4294967296) {
